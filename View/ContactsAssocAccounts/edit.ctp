<?php 
// File: Plugin/Contacts/View/ContactsAssocAccount/edit.ctp
?>
<div class="top">
	<h1><?php echo __('Edit %s: (ID:%s) %s', __('Associated Account'), $this->data['AssocAccount']['id'], $this->data['AssocAccount']['username']); ?></h1>
</div>
<div class="center">
	<div class="form">
