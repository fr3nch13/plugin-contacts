<?php 
// File: Plugin/Contacts/View/ContactsAdAccounts/edit.ctp

$form_id = (isset($form_id)?$form_id:rand(1,1000));
?>
<div class="top">
	<h1><?php echo __('Edit %s: (ID:%s) %s', __('AD Account'), $this->data['AdAccount']['id'], $this->data['AdAccount']['username']); ?></h1>
</div>
<div class="center">
